...
export function ManualNewToolComponent({ onSubmit }: { onSubmit: (tool: Tool | null) => void }) {
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="flex flex-col gap-3">
          <Label htmlFor="tool-name-full">
            Tool Name<span className="ml-1 text-destructive">*</span>
          </Label>
          <Input
            required
            id="tool-name-full"
