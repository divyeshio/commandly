  ...
  return (
    <>
      <a
        ...
        aria-label="GitHub"
        className="flex size-9 items-center justify-center rounded-full text-foreground/80 transition-colors hover:text-primary"
      >
        <svg
          width="20"
          height="20"
          ...
          >
            ...
            >
              ...
              <div className="flex h-full flex-col px-6 pt-8">
                ...
                <div className="mt-auto flex items-center justify-center gap-3 pb-8">
                  <SocialLinks />
                </div>
              </div>
            </SheetContent>
